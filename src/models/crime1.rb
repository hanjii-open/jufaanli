    ...
    Doc.match(NAME).find_in_batches do |doc_batch|
      batch = doc_batch.map do |doc|
        ...
        end
        {
          ...
          d5t: d5s.presence && d5s.map { Doc.translate_rmb(_1) }.sum,
          d6: 'TODO',
          ...
          d19: d19 = /有期徒刑[^#{Doc::PUNS}]*?([#{Doc::NUMS}#{Doc::DATES} ]+)/.match(conclusion)&.[](1),
          d19t: Doc.translate_date(d19),
          d20: d20 = /罚金/.match?(conclusion),
          d21: d21 = d20.presence && /罚金[^#{Doc::PUNS}]*?(#{Doc::RMB_EXP})/.match(conclusion)&.[](1),
          d21t: Doc.translate_rmb(d21),
          d22: d22 = /缓刑/.match?(conclusion),
          d23: d23 = d22.presence && /缓刑[^#{Doc::PUNS}]*?([#{Doc::NUMS}#{Doc::DATES} ]+)/.match(conclusion)&.[](1),
          d23t: Doc.translate_date(d23),
          d24: doc.region,
